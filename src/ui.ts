...
export function logStatus(message: any) {
  statusElement.innerText = message;
}

export function trainingLog(message: any) {
  messageElement.innerText = `${message}\n`;
  console.log(message);
}

export function showTestResults(batch: any, predictions: any, labels: any) {
...
export function plotLoss(batch: any, loss: any, set: any) {
...
export function plotAccuracy(batch: any, accuracy: any, set: any) {
...
export function draw(image: any, canvas: any) {
...
export function getModelTypeId() {
  return (document.getElementById('model-type') as any).value;
}

export function getTrainEpochs() {
  return Number.parseInt((document.getElementById('train-epochs') as any).value);
}
